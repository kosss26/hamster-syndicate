    ...
    <div className="min-h-screen bg-aurora relative overflow-hidden">
      ...
      <div className="relative z-10 p-4 pb-24">
        ...
        <motion.div 
          ...
          initial="hidden"
          animate="show"
          key={activeTab} // Перезапуск анимации при смене таба
          className="space-y-2"
        >
          {data.map((player, index) => {
            ...
            return (
              <motion.div
                key={`${activeTab}-${player.username || index}`}
        ...
        {/* Current user position card - Fixed at bottom if needed, or just in list */}
        {currentUserPosition > 20 && currentUserPosition > 0 && (
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.5 }}
            className="mt-6 bento-card p-5 border-t border-white/10"
          >
             <div className="relative flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-game-primary to-purple-600 flex items-center justify-center text-lg font-bold text-white shadow-glow">
              ...
              <div className="text-right">
                <p className="text-2xl font-bold text-gradient-primary">#{currentUserPosition}</p>
